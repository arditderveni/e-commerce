 ...
 *
 * @component
 * @param props - The properties for the ProductCard component.
 ...
 * @param props.ingredients - The ingredients of the product.
 * @param props.features - The features of the product.
 * @param props.className - Additional class names for styling.
 * @param props.ref - Reference to the component.
 * @param props.id - The unique identifier for the product.
 * @param props.wishListed - Indicates if the product is wishlisted.
 * @param props.variant - The variant of the product card (e.g., "shop").
 * @param props.addItem - Function to add the product to the cart.
 *

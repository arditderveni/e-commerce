 ...
 * @param props.alt - The alt text for the avatar image, typically the user's name.
 * @param props.className - Additional class names to apply to the avatar component.

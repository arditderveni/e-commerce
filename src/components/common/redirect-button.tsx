 ...
 *
 * @component
 * @param props - The properties for the RedirectButton component.
 * @param props.route - The route to which the user will be redirected.
 * @param props.title - The text to be displayed on the button.
 * @param props.className - Optional additional CSS class names to style the button.
 *
 * @example
